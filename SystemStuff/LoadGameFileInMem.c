...
int LoadGameFileInMem(uint param_1,char *param_2,char *param_3)

{
  ...
  local_c = (char *)0x0;
  if (param_3 != (char *)0x0) {
    piVar1 = &DAT_00c47260 + ((int)param_1 >> 5);
    iVar9 = (param_1 & 0x1f) * 0x24;
    bVar4 = *(byte *)((&DAT_00c47260)[(int)param_1 >> 5] + iVar9 + 4);
    if ((bVar4 & 2) == 0) {
      pcVar8 = param_2;
      if (((bVar4 & 0x48) != 0) &&
         (cVar3 = *(char *)((&DAT_00c47260)[(int)param_1 >> 5] + iVar9 + 5), cVar3 != '\n')) {
      ...
      if (BVar5 == 0) {
        DVar6 = GetLastError();
        if (DVar6 == 5) {
          puVar7 = (undefined4 *)GetOrCreateTlsBlock_Stub2();
          *puVar7 = 9;
          puVar7 = (undefined4 *)GetOrCreateTlsBlock_stub3();
          *puVar7 = 5;
        }
        else {
          if (DVar6 == 0x6d) {
...
LAB_004b19a6:
                ...
                FUN_004b1667(param_1,0xffffffff,1);
                if (local_5 != '\n') goto LAB_004b19c0;
              }
              else {
                if (local_5 == '\n') goto LAB_004b19a6;
