...
void CEntities__MoveSceneEntryAndEaseFacingAngles(int param_1,uint param_2)
    ...
    *(int *)(iVar1 + 0x1c) = *(int *)(iVar1 + 0x1c) + *(int *)(iVar1 + 0x5c);
    ...
    if ((int)*(short *)(iVar1 + 0xa2) != uVar3) {
      ...
      if ((iVar2 >> 2 ^ iVar2 >> 0x1f) - (iVar2 >> 0x1f) < 2) {
        ...
        *(short *)(iVar1 + 0xa2) = *(short *)(iVar1 + 0xa2) + (short)(iVar2 >> 2);
      }
    ...
    if ((int)*(short *)(iVar1 + 0xa0) != uVar5) {
      ...
      *(short *)(iVar1 + 0xa0) = *(short *)(iVar1 + 0xa0) + (short)(iVar2 >> 2);
      *(ushort *)(iVar1 + 0xa0) = *(ushort *)(iVar1 + 0xa0) & 0xfff;
    }
  }
  return;
