...
// Address: 0x004310F0
// Label: CEntities::InitSmashableFlyingDebris
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CEntities::InitSmashableFlyingDebris(int entry)

{
  ...
  if (value2 != 0) {
    ...
    *(undefined4 *)(value2 + 0x10) = ((EntitySceneObject *)value)->y;
    *(undefined4 *)(value2 + 0x14) = ((EntitySceneObject *)value)->z;
    ...
    *(undefined4 *)(value2 + 0x74) = 0x4c;
    *(undefined4 *)(value2 + 0x34) = 0;
    *(int *)(value2 + 0x48) = *(int *)(entity->sceneObjects + 0x18) + 0x200;
  }
  return;
}
