...
// Address: 0x004207A0
// Label: CEntities::UpdateSurfaceEnemyVariantC
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CEntities::UpdateSurfaceEnemyVariantC(int entry)

{
  ...
  if (resultFlag2 != '\0') {
    if (*(short *)(entry + 0x3e) < 1) goto LAB_0042087b;
...
LAB_004209c6:
  ...
  case 3:
    ...
    if (*(char *)(value4 + 0x75) == '\0') {
      if (0x400 < value2 - value) goto LAB_004209b2;
