...
// Address: 0x0042FB60
// Label: CEntities::MoveEntityWithCollisionAndEaseSurfaceAngles
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CEntities::MoveEntityWithCollisionAndEaseSurfaceAngles(int entry,uint sceneObject)

{
  ...
  if (entry2 != 0) {
    ...
    if ((int)((EntitySceneObject *)entry2)->yaw != value) {
      ...
      if ((entry3 >> 3 ^ entry3 >> 0x1f) - (entry3 >> 0x1f) < 2) {
        ((EntitySceneObject *)entry2)->yaw = (short)value;
      }
      else {
        ((EntitySceneObject *)entry2)->yaw = ((EntitySceneObject *)entry2)->yaw + (short)(entry3 >> 3);
      }
    ...
    if ((int)*(short *)(entry2 + 0xa0) != value3) {
      ...
      *(short *)(entry2 + 0xa0) = *(short *)(entry2 + 0xa0) + (short)(entry3 >> 3);
      *(ushort *)(entry2 + 0xa0) = *(ushort *)(entry2 + 0xa0) & 0xfff;
    }
  }
  return;
