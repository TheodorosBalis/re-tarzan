...
// Address: 0x00420C40
// Label: CEntities::UpdateProjectileSurfaceEnemyVariantC
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CEntities::UpdateProjectileSurfaceEnemyVariantC(int entry)

{
  ...
  if (resultFlag == '\0') {
    ...
    if (*(short *)(entry + 0x3e) < 1) goto LAB_00420ce9;
