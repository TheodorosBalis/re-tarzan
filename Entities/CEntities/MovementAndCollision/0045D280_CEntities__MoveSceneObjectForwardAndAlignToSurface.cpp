...
// Address: 0x0045D280
// Label: CEntities::MoveSceneObjectForwardAndAlignToSurface
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CEntities::MoveSceneObjectForwardAndAlignToSurface(undefined4 entry,int sceneObject,int attachment)
