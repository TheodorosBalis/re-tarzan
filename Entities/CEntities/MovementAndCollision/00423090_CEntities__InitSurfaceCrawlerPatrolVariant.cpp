...
// Address: 0x00423090
// Label: CEntities::InitSurfaceCrawlerPatrolVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CEntities::InitSurfaceCrawlerPatrolVariant(int entry)

{
  ...
  if (value != 0) {
    ...
    *(undefined2 *)(value + 0x140) = 0;
    ...
    CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004c69c8);
