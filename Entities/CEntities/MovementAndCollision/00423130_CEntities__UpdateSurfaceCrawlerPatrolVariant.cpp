...
// Address: 0x00423130
// Label: CEntities::UpdateSurfaceCrawlerPatrolVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CEntities::UpdateSurfaceCrawlerPatrolVariant(int entry)
...
LAB_0042333a:
    ...
    if (value6 < 0x32) goto LAB_0042333a;
    if (flagByte == 0) goto LAB_00423335;
  }
