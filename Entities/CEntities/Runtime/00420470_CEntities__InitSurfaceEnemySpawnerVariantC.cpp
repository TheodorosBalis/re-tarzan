...
// Address: 0x00420470
// Label: CEntities::InitSurfaceEnemySpawnerVariantC
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CEntities::InitSurfaceEnemySpawnerVariantC(int entry)

{
  ...
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    value2 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0x1bc);
    value3 = CEntities::CountEntitiesOfTypeInList(g_ActiveEntityListHead,0x1b9);
