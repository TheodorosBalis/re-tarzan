...
// Address: 0x00421FE0
// Label: CEntities::UpdateChargingGroundAnimalVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CEntities::UpdateChargingGroundAnimalVariant(int entry)

{
  ...
  if (value4 == 0) goto switchD_00422193_default;
