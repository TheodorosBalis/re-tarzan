...
// Address: 0x0047F570
// Label: CEntities::TerkSwimmingUpdateBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CEntities::TerkSwimmingUpdateBird(int entry)
