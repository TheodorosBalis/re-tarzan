...
// Address: 0x00421AD0
// Label: CEntities::InitGroundAnimalVariantF
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CEntities::InitGroundAnimalVariantF(int entry)
  ...
  *(uint *)(entry + 0x28) = *(uint *)(entry + 0x28) | 0x1000;
  if (value != 0) {
    ...
    *(undefined2 *)(value + 0x140) = 0;
    ...
    CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004c66d0);
