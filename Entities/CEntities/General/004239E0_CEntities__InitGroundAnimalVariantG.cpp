...
// Address: 0x004239E0
// Label: CEntities::InitGroundAnimalVariantG
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CEntities::InitGroundAnimalVariantG(int entry)
  ...
  *(uint *)(entry + 0x28) = *(uint *)(entry + 0x28) | 0x1000;
  ...
  if (value != 0) {
    ...
    *(undefined2 *)(value + 0x140) = 0;
    ...
    CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004c6cd8);
