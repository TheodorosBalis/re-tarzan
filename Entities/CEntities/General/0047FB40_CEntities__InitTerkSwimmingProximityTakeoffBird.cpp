...
// Address: 0x0047FB40
// Label: CEntities::InitTerkSwimmingProximityTakeoffBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CEntities::InitTerkSwimmingProximityTakeoffBird(int entry)

{
  ...
  CEntities::InitTerkSwimmingBirdCommon(entry);
  ...
  if (value3 != 0) {
    ...
    if (value != 0) {
      *(code **)(value + 0xc) = CEntities::TerkSwimmingBirdProximityTakeoffCallback;
