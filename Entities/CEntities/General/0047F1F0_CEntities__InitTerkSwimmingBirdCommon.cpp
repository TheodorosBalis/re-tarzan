...
// Address: 0x0047F1F0
// Label: CEntities::InitTerkSwimmingBirdCommon
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CEntities::InitTerkSwimmingBirdCommon(int entry)
...
LAB_0047f242:
  ...
  *(undefined2 *)(entry + 0x4a) = 0;
  ...
  switch(localState2) {
  case 0:
    dataCursor = &g_TerkSwimmingBirdScriptAttachmentDesc_Variant0;
  ...
  case 2:
    ...
    goto LAB_0047f3e2;
  case 3:
    dataCursor = &g_TerkSwimmingBirdScriptAttachmentDesc_Variant2;
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x6e8;
LAB_0047f2d1:
...
LAB_0047f3e2:
  ...
  case 0x10:
    ...
    value = CEntities::SetEntitySceneObjectScriptAttachment
                      (entry,&g_TerkSwimmingBirdScriptAttachmentDesc_Variant16);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 0x11:
    dataCursor = &g_TerkSwimmingBirdScriptAttachmentDesc_Variant17;
...
LAB_0047f440:
    ...
    *(short *)(value + 0x16) = shortValue;
    if (4 < shortValue) goto LAB_0047f440;
  }
