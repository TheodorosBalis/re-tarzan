...
// Address: 0x0043C1C0
// Label: WelcomeToTheJungle::InitProjectileDropBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void WelcomeToTheJungle::InitProjectileDropBird(int entry)

{
  ...
  *(uint *)(entry + 0x28) = *(uint *)(entry + 0x28) | 4;
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      *(code **)(value + 0xc) = WelcomeToTheJungle::BirdProjectileDropCallback;
