...
// Address: 0x0043B630
// Label: WelcomeToTheJungle::InitBirdCommon
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void WelcomeToTheJungle::InitBirdCommon(int entry)
...
LAB_0043b682:
  ...
  *(undefined2 *)(entry + 0x4a) = 0;
  ...
  switch(localState2) {
  case 0:
    dataCursor = &g_BirdScriptAttachmentDesc_Variant0;
  ...
  case 2:
    ...
    goto LAB_0043b822;
  case 3:
    dataCursor = &g_BirdScriptAttachmentDesc_Variant2;
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x6e8;
LAB_0043b711:
...
LAB_0043b822:
  ...
  case 0x10:
    ...
    value = CEntities::SetEntitySceneObjectScriptAttachment
                      (entry,&g_BirdScriptAttachmentDesc_Variant16);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 0x11:
    dataCursor = &g_BirdScriptAttachmentDesc_Variant17;
...
LAB_0043b880:
    ...
    *(short *)(value + 0x16) = shortValue;
    if (4 < shortValue) goto LAB_0043b880;
  }
