...
// Address: 0x0043E880
// Label: WelcomeToTheJungle::UpdateProjectileThrowingMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void WelcomeToTheJungle::UpdateProjectileThrowingMonkey(int entry)

{
  ...
  if ((value2 != 0) &&
    ...
    if (resultFlag != '\0') {
      if (*(short *)(entry + 0x3e) < 1) goto LAB_0043e92e;
