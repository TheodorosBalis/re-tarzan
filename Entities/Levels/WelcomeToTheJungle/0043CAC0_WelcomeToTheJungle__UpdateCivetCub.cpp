...
// Address: 0x0043CAC0
// Label: WelcomeToTheJungle::UpdateCivetCub
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void WelcomeToTheJungle::UpdateCivetCub(int entry)
  ...
  case 1:
    ...
    *(int *)(entry + 0x4c) = value3;
    ...
    if (*(char *)(value2 + 0x75) == '\0') {
      if (400 < value5 - value4) goto LAB_0043cca2;
...
LAB_0043cca2:
      ...
      if (((int)value7 < 1) || (0x1c1 < (int)value7)) goto LAB_0043cc03;
      if (*(char *)(value2 + 0x75) != '\0') {
