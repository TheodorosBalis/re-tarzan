...
// Address: 0x0043A470
// Label: WelcomeToTheJungle::ProjectileThrowingBaboonScriptCallback
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void WelcomeToTheJungle::ProjectileThrowingBaboonScriptCallback
...

{
  ...
  case 1:
    ...
    *(int *)(arg1 + 0x4c) = value2;
    if (value < 0x7d1) {
      if (value < 500) goto LAB_0043a55f;
      if (value2 < 0x23) {
