...
// Address: 0x0043CF20
// Label: WelcomeToTheJungle::UpdateLeapingGroundEnemy
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void WelcomeToTheJungle::UpdateLeapingGroundEnemy(int entry)

{
  ...
  if (value3 == 0) goto LAB_0043d0fe;
  value2 = CEntities::FindEntityAttachmentByFlags(entry,0x400);
  if (value2 == 0) goto LAB_0043d0fe;
  ...
  if (shortValue != 1) {
    if (shortValue == 2) {
      if ((*(byte *)(entry + 0x4a) & 2) == 0) {
        ...
        *(int *)(value3 + 0x40) =
             *(int *)(&g_LeapingGroundEnemyHopYOffsetTable + *(int *)(entry + 0x50) * 4) * -8;
...
LAB_0043d07d:
    ...
    if (flagByte == 0) goto LAB_0043d07d;
  }
