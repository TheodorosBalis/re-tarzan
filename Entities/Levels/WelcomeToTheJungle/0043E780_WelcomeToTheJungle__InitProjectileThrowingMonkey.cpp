...
// Address: 0x0043E780
// Label: WelcomeToTheJungle::InitProjectileThrowingMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void WelcomeToTheJungle::InitProjectileThrowingMonkey(int entry)

{
  ...
  *(uint *)(entry + 0x28) = *(uint *)(entry + 0x28) | 0x1004;
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    value2 = CEntities::CountEntitiesOfTypeInList(g_ActiveEntityListHead,0x36);
    if (value + value2 < 2) {
