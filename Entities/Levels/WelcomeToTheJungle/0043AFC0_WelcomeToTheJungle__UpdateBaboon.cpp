...
// Address: 0x0043AFC0
// Label: WelcomeToTheJungle::UpdateBaboon
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void WelcomeToTheJungle::UpdateBaboon(int entry)
...
LAB_0043b221:
                ...
                if (0x17b < value) {
                  if (*(char *)(value5 + 0x75) == '\0') goto LAB_0043b211;
                  goto LAB_0043b221;
                }
                value6 = 10;
              }
...
LAB_0043b161:
              ...
              if (0x17b < value4 - value) {
                if (*(char *)(value5 + 0x75) == '\0') goto LAB_0043b153;
                goto LAB_0043b161;
              }
              value6 = 10;
            }
