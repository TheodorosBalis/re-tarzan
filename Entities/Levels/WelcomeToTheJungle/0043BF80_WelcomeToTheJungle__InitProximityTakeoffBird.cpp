...
// Address: 0x0043BF80
// Label: WelcomeToTheJungle::InitProximityTakeoffBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void WelcomeToTheJungle::InitProximityTakeoffBird(int entry)

{
  ...
  WelcomeToTheJungle::InitBirdCommon(entry);
  ...
  if (value3 != 0) {
    ...
    if (value != 0) {
      *(code **)(value + 0xc) = WelcomeToTheJungle::BirdProximityTakeoffCallback;
