...
// Address: 0x0043D120
// Label: WelcomeToTheJungle::InitCivet
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void WelcomeToTheJungle::InitCivet(int entry)
  ...
  *(uint *)(entry + 0x28) = *(uint *)(entry + 0x28) | 0x1000;
  if (value != 0) {
    ...
    *(undefined2 *)(value + 0x140) = 0;
    ...
    CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&g_CivetScriptAttachmentDesc);
