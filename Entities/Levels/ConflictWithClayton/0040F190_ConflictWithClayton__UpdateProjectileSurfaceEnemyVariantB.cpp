...
// Address: 0x0040F190
// Label: ConflictWithClayton::UpdateProjectileSurfaceEnemyVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ConflictWithClayton::UpdateProjectileSurfaceEnemyVariantB(int entry)

{
  ...
  if ((value2 != 0) &&
    ...
    if (resultFlag != '\0') {
      if (*(short *)(entry + 0x3e) < 1) goto LAB_0040f23e;
