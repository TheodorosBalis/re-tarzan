...
// Address: 0x0040E7E0
// Label: ConflictWithClayton::UpdateSurfaceEnemyVariantC
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ConflictWithClayton::UpdateSurfaceEnemyVariantC(int entry)

{
  ...
  if (resultFlag2 != '\0') {
    if (*(short *)(entry + 0x3e) < 1) goto LAB_0040e8bb;
...
LAB_0040ea06:
  ...
  case 3:
    ...
    if (*(char *)(value4 + 0x75) == '\0') {
      if (0x400 < value2 - value) goto LAB_0040e9f2;
