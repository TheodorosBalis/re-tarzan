...
// Address: 0x0040EC80
// Label: ConflictWithClayton::UpdateProjectileSurfaceEnemyVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ConflictWithClayton::UpdateProjectileSurfaceEnemyVariant(int entry)

{
  ...
  if (resultFlag == '\0') {
    ...
    if (*(short *)(entry + 0x3e) < 1) goto LAB_0040ed29;
