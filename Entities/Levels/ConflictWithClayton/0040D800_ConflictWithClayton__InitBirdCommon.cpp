...
// Address: 0x0040D800
// Label: ConflictWithClayton::InitBirdCommon
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ConflictWithClayton::InitBirdCommon(int entry)
...
LAB_0040d852:
  ...
  *(undefined2 *)(entry + 0x4a) = 0;
  ...
  switch(localState2) {
  case 0:
    dataCursor = &g_ConflictWithClaytonBirdScriptAttachmentDescB;
  ...
  case 2:
    ...
    goto LAB_0040d9f2;
  case 3:
    dataCursor = &g_ConflictWithClaytonBirdScriptAttachmentDescC;
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x6e8;
LAB_0040d8e1:
...
LAB_0040d9f2:
  ...
  case 0x10:
    ...
    value = CEntities::SetEntitySceneObjectScriptAttachment
                      (entry,&g_ConflictWithClaytonBirdScriptAttachmentDescE);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 0x11:
    dataCursor = &g_ConflictWithClaytonBirdScriptAttachmentDescF;
...
LAB_0040da50:
    ...
    *(short *)(value + 0x16) = shortValue;
    if (4 < shortValue) goto LAB_0040da50;
  }
