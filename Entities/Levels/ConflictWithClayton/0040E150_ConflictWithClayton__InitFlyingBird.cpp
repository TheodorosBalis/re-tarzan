...
// Address: 0x0040E150
// Label: ConflictWithClayton::InitFlyingBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ConflictWithClayton::InitFlyingBird(int entry)

{
  ...
  if (value3 != 0) {
    ...
    if (value != 0) {
      *(code **)(value + 0xc) = ConflictWithClayton::TriggerBirdTakeoffWhenPlayerNear;
