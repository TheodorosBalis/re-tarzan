...
// Address: 0x0040F080
// Label: ConflictWithClayton::InitProjectileSurfaceEnemyVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ConflictWithClayton::InitProjectileSurfaceEnemyVariantB(int entry)

{
  ...
  *(uint *)(entry + 0x28) = *(uint *)(entry + 0x28) | 0x1004;
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    value2 = CEntities::CountEntitiesOfTypeInList(g_ActiveEntityListHead,0x180);
    if (value + value2 < 2) {
