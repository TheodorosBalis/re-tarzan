...
// Address: 0x0040E6B0
// Label: ConflictWithClayton::InitSurfaceEnemyVariantC
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ConflictWithClayton::InitSurfaceEnemyVariantC(int entry)
  ...
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      ...
      *(undefined2 *)(value + 0x140) = 0x100;
      CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004c0428);
    ...
    value2 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0x184);
    value3 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0x183);
