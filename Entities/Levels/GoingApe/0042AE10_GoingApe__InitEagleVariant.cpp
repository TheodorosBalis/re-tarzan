...
// Address: 0x0042AE10
// Label: GoingApe::InitEagleVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void GoingApe::InitEagleVariant(int entry)

{
  ...
  if (value != 0) {
    ...
    *(undefined2 *)(value + 0x140) = 0;
    ...
    CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&g_GoingApeEagleScriptDesc);
