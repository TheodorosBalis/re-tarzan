...
// Address: 0x0042B9B0
// Label: GoingApe::UpdateFrog
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void GoingApe::UpdateFrog(int entry)

{
  ...
  if (value3 == 0) goto LAB_0042bb8e;
  value2 = CEntities::FindEntityAttachmentByFlags(entry,0x400);
  if (value2 == 0) goto LAB_0042bb8e;
  ...
  if (shortValue != 1) {
    if (shortValue == 2) {
      if ((*(byte *)(entry + 0x4a) & 2) == 0) {
        ...
        *(int *)(value3 + 0x40) =
             *(int *)(&g_GoingApeFrogHopVerticalVelocityTable + *(int *)(entry + 0x50) * 4) * -8;
...
LAB_0042bb0d:
    ...
    if (flagByte == 0) goto LAB_0042bb0d;
  }
