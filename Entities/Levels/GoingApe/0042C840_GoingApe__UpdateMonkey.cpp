...
// Address: 0x0042C840
// Label: GoingApe::UpdateMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void GoingApe::UpdateMonkey(int entry)

{
  ...
  if (resultFlag2 != '\0') {
    if (*(short *)(entry + 0x3e) < 1) goto LAB_0042c91b;
...
LAB_0042ca66:
  ...
  case 3:
    ...
    if (*(char *)(value4 + 0x75) == '\0') {
      if (0x400 < value2 - value) goto LAB_0042ca52;
