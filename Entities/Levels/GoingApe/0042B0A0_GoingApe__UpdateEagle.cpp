...
// Address: 0x0042B0A0
// Label: GoingApe::UpdateEagle
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void GoingApe::UpdateEagle(int entry)
...
LAB_0042b2aa:
    ...
    if (value6 < 0x32) goto LAB_0042b2aa;
    if (flagByte == 0) goto LAB_0042b2a5;
  }
