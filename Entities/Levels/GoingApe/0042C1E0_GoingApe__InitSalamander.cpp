...
// Address: 0x0042C1E0
// Label: GoingApe::InitSalamander
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void GoingApe::InitSalamander(int entry)

{
  ...
  if (value != 0) {
    ...
    *(undefined2 *)(value + 0xa0) = 0x400;
    CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&g_GoingApeSalamanderScriptDesc);
