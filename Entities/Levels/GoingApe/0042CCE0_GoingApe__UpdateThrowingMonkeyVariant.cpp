...
// Address: 0x0042CCE0
// Label: GoingApe::UpdateThrowingMonkeyVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void GoingApe::UpdateThrowingMonkeyVariant(int entry)

{
  ...
  if (resultFlag == '\0') {
    ...
    if (*(short *)(entry + 0x3e) < 1) goto LAB_0042cd89;
