...
// Address: 0x0042CBD0
// Label: GoingApe::InitThrowingMonkeyVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void GoingApe::InitThrowingMonkeyVariant(int entry)
  ...
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      ...
      *(undefined2 *)(value + 0x140) = 0x100;
      value2 = (int)CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004ebf80);
      if (value2 != 0) {
