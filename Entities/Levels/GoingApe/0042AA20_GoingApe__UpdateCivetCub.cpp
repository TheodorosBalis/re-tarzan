...
// Address: 0x0042AA20
// Label: GoingApe::UpdateCivetCub
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void GoingApe::UpdateCivetCub(int entry)
  ...
  case 1:
    ...
    *(int *)(entry + 0x4c) = value3;
    ...
    if (*(char *)(value2 + 0x75) == '\0') {
      if (400 < value5 - value4) goto LAB_0042ac02;
...
LAB_0042ac02:
      ...
      if (((int)value7 < 1) || (0x1c1 < (int)value7)) goto LAB_0042ab63;
      if (*(char *)(value2 + 0x75) != '\0') {
