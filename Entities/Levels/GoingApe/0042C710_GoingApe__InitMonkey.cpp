...
// Address: 0x0042C710
// Label: GoingApe::InitMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void GoingApe::InitMonkey(int entry)
  ...
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      ...
      *(undefined2 *)(value + 0x140) = 0x100;
      CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&g_GoingApeMonkeyScriptDesc);
    ...
    value2 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0x66);
    value3 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0x65);
