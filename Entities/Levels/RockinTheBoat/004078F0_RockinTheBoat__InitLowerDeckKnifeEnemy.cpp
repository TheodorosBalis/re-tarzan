...
// Address: 0x004078F0
// Label: RockinTheBoat::InitLowerDeckKnifeEnemy
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void RockinTheBoat::InitLowerDeckKnifeEnemy(int entry)

{
  ...
  if (-0x500 < *(int *)(g_PlayerEntitySceneObjectData + 0xc)) {
