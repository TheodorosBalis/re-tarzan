...
// Address: 0x00405B20
// Label: RockinTheBoat::InitBox
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void RockinTheBoat::InitBox(int entry)
  ...
  if (value2 != 0) {
    ...
    if (entity->descriptor != 0) {
      ...
      *(undefined2 *)(value2 + 0xc) =
           *(undefined2 *)(&g_RockinBoxSceneObjectIdByVariantTable + *(int *)(value + 4) * 2);
    ...
    CEntities::AppendEntityToChildChain(g_RockinTheBoatKnifeEnemyControllerEntry,entry);
  }
  return;
}
