...
// Address: 0x00408150
// Label: RockinTheBoat::InitShipBreakDebrisEmitter
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void RockinTheBoat::InitShipBreakDebrisEmitter(int entry)
