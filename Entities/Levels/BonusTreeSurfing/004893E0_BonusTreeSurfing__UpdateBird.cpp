...
// Address: 0x004893E0
// Label: BonusTreeSurfing::UpdateBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void BonusTreeSurfing::UpdateBird(int entry)
