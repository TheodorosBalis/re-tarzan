...
// Address: 0x004899B0
// Label: BonusTreeSurfing::InitProximityTakeoffBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void BonusTreeSurfing::InitProximityTakeoffBird(int entry)

{
  ...
  BonusTreeSurfing::InitBirdCommon(entry);
  ...
  if (value3 != 0) {
    ...
    if (value != 0) {
      *(code **)(value + 0xc) = BonusTreeSurfing::TriggerBirdTakeoffWhenPlayerNear;
