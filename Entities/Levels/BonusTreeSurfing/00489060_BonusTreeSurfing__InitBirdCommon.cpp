...
// Address: 0x00489060
// Label: BonusTreeSurfing::InitBirdCommon
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void BonusTreeSurfing::InitBirdCommon(int entry)
...
LAB_004890b2:
  ...
  *(undefined2 *)(entry + 0x4a) = 0;
  ...
  switch(localState2) {
  case 0:
    dataCursor = &g_BonusTreeSurfingBirdScriptAttachmentDesc_Variant0;
  ...
  case 2:
    ...
    goto LAB_00489252;
  case 3:
    dataCursor = &g_BonusTreeSurfingBirdScriptAttachmentDesc_Variant2;
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x6e8;
LAB_00489141:
  ...
  case 4:
    ...
    value = CEntities::SetEntitySceneObjectScriptAttachment
                      (entry,&g_BonusTreeSurfingBirdScriptAttachmentDesc_Variant4);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 5:
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x820;
    value = CEntities::SetEntitySceneObjectScriptAttachment
                      (entry,&g_BonusTreeSurfingBirdScriptAttachmentDesc_Variant5);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 6:
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x750;
...
LAB_00489252:
  ...
  case 0x10:
    ...
    value = CEntities::SetEntitySceneObjectScriptAttachment
                      (entry,&g_BonusTreeSurfingBirdScriptAttachmentDesc_Variant16);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 0x11:
    dataCursor = &g_BonusTreeSurfingBirdScriptAttachmentDesc_Variant17;
...
LAB_004892b0:
    ...
    *(short *)(value + 0x16) = shortValue;
    if (4 < shortValue) goto LAB_004892b0;
  }
