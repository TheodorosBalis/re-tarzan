...
// Address: 0x00401000
// Label: TheBaboonChase::InitBirdCommon
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void TheBaboonChase::InitBirdCommon(int entry)
...
LAB_004010e1:
  ...
  case 4:
    ...
    value = (int)CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004bc388);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 5:
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x820;
    value = (int)CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004bc3b8);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 6:
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x750;
...
LAB_004011f2:
  ...
  case 0x10:
    ...
    value = (int)CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004bc3c8);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 0x11:
    dataCursor = &DAT_004bc3d8;
...
LAB_00401250:
    ...
    *(short *)(value + 0x16) = shortValue;
    if (4 < shortValue) goto LAB_00401250;
  }
