...
// Address: 0x00483DC0
// Label: TerkLeafSwimming::InitDropSplash
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void TerkLeafSwimming::InitDropSplash(int entry)

{
  ...
  if (value != 0) {
    ...
    *(undefined2 *)(entity->sceneObjects + 0xc) = 0x201d;
    ...
    *(undefined4 *)(value + 0xc) = 0;
    ...
    CEntities::SpawnEntityByTypeAtPosition
              (((EntitySceneObject *)value)->x,((EntitySceneObject *)value)->y,
               ((EntitySceneObject *)value)->z,0x1a8,0x11);
    value = entity->sceneObjects;
