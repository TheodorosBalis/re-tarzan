...
// Address: 0x0045C6F0
// Label: StorkRide::InitBonusFruitPickup
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void StorkRide::InitBonusFruitPickup(int entry)

{
  ...
  if (value != 0) {
    ...
    ((EntitySceneObject *)value)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x21b8;
