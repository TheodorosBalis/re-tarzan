...
// Address: 0x00426F40
// Label: ElephantHairDare::InitThrowingMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ElephantHairDare::InitThrowingMonkey(int entry)

{
  ...
  *(uint *)(entry + 0x28) = *(uint *)(entry + 0x28) | 0x1004;
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    value2 = CEntities::CountEntitiesOfTypeInList(g_ActiveEntityListHead,0x6a);
    if (value + value2 < 2) {
