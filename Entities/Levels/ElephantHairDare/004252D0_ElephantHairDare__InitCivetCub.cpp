...
// Address: 0x004252D0
// Label: ElephantHairDare::InitCivetCub
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ElephantHairDare::InitCivetCub(int entry)
  ...
  *(uint *)(entry + 0x28) = *(uint *)(entry + 0x28) | 0x1000;
  if (value != 0) {
    ...
    *(undefined2 *)(value + 0x140) = 0;
    ...
    CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&g_ElephantHairDareCivetCubScriptDesc);
