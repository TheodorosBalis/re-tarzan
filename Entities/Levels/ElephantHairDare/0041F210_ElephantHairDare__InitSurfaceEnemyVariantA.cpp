...
// Address: 0x0041F210
// Label: ElephantHairDare::InitSurfaceEnemyVariantA
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ElephantHairDare::InitSurfaceEnemyVariantA(int entry)
  ...
  *(uint *)(entry + 0x28) = *(uint *)(entry + 0x28) | 0x1004;
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      ...
      if (value != 0) {
        *(code **)(&((EntitySceneObject *)value)->worldObject) = ElephantHairDare::SurfaceEnemyVariantABehaviorCallback;
      }
    }
