...
// Address: 0x00425740
// Label: ElephantHairDare::InitEagleVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ElephantHairDare::InitEagleVariant(int entry)

{
  ...
  if (value != 0) {
    ...
    *(undefined2 *)(value + 0x140) = 0;
    ...
    CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&g_ElephantHairDareEagleScriptDesc);
