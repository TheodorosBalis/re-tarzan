...
// Address: 0x00424540
// Label: ElephantHairDare::UpdateBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ElephantHairDare::UpdateBird(int entry)
