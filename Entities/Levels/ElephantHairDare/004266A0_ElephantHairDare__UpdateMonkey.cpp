...
// Address: 0x004266A0
// Label: ElephantHairDare::UpdateMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ElephantHairDare::UpdateMonkey(int entry)

{
  ...
  if (resultFlag2 != '\0') {
    if (*(short *)(entry + 0x3e) < 1) goto LAB_0042677b;
...
LAB_004268c6:
  ...
  case 3:
    ...
    if (*(char *)(value4 + 0x75) == '\0') {
      if (0x400 < value2 - value) goto LAB_004268b2;
