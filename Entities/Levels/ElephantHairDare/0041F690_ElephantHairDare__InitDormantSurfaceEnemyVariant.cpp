...
// Address: 0x0041F690
// Label: ElephantHairDare::InitDormantSurfaceEnemyVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ElephantHairDare::InitDormantSurfaceEnemyVariant(int entry)
  ...
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      ...
      *(undefined2 *)(value + 0x140) = 0;
      ...
      value = ElephantHairDare::InitSurfaceEnemySharedState(entry);
      if (value != 0) {
        *(code **)(&((EntitySceneObject *)value)->worldObject) = ElephantHairDare::DormantSurfaceEnemyBehaviorCallback;
