...
// Address: 0x00426570
// Label: ElephantHairDare::InitMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ElephantHairDare::InitMonkey(int entry)
  ...
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      ...
      *(undefined2 *)(value + 0x140) = 0x100;
      CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&g_ElephantHairDareMonkeyScriptDesc);
    ...
    value2 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0x6e);
    value3 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0x6d);
