...
// Address: 0x00425350
// Label: ElephantHairDare::UpdateCivetCub
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ElephantHairDare::UpdateCivetCub(int entry)
  ...
  case 1:
    ...
    *(int *)(entry + 0x4c) = value3;
    ...
    if (*(char *)(value2 + 0x75) == '\0') {
      if (400 < value5 - value4) goto LAB_00425532;
...
LAB_00425532:
      ...
      if (((int)value7 < 1) || (0x1c1 < (int)value7)) goto LAB_00425493;
      if (*(char *)(value2 + 0x75) != '\0') {
