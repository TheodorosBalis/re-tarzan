...
// Address: 0x00425E40
// Label: ElephantHairDare::UpdateFrog
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ElephantHairDare::UpdateFrog(int entry)

{
  ...
  if (value3 == 0) goto LAB_0042601e;
  value2 = CEntities::FindEntityAttachmentByFlags(entry,0x400);
  if (value2 == 0) goto LAB_0042601e;
  ...
  if (shortValue != 1) {
    if (shortValue == 2) {
      if ((*(byte *)(entry + 0x4a) & 2) == 0) {
        ...
        *(int *)(value3 + 0x40) =
             *(int *)(&g_ElephantHairDareFrogHopVerticalVelocityTable + *(int *)(entry + 0x50) * 4
                     ) * -8;
...
LAB_00425f9d:
    ...
    if (flagByte == 0) goto LAB_00425f9d;
  }
