...
// Address: 0x00426370
// Label: ElephantHairDare::InitMonkeySpawner
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ElephantHairDare::InitMonkeySpawner(int entry)

{
  ...
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    value2 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0x6d);
    value3 = CEntities::CountEntitiesOfTypeInList(g_ActiveEntityListHead,0x6a);
