...
// Address: 0x004259D0
// Label: ElephantHairDare::UpdateEagle
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ElephantHairDare::UpdateEagle(int entry)
...
LAB_00425bda:
    ...
    if (value6 < 0x32) goto LAB_00425bda;
    if (flagByte == 0) goto LAB_00425bd5;
  }
