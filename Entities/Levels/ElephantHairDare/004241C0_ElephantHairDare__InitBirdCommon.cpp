...
// Address: 0x004241C0
// Label: ElephantHairDare::InitBirdCommon
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ElephantHairDare::InitBirdCommon(int entry)
...
LAB_00424212:
  ...
  *(undefined2 *)(entry + 0x4a) = 0;
  ...
  switch(localState2) {
  case 0:
    dataCursor = &g_ElephantHairDareBirdScriptDesc_3330;
  ...
  case 2:
    ...
    goto LAB_004243b2;
  case 3:
    dataCursor = &g_ElephantHairDareBirdScriptDesc_3340;
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x6e8;
LAB_004242a1:
...
LAB_004243b2:
  ...
  case 0x10:
    ...
    value = CEntities::SetEntitySceneObjectScriptAttachment
                      (entry,&g_ElephantHairDareBirdScriptDesc_3360);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 0x11:
    dataCursor = &g_ElephantHairDareBirdScriptDesc_3370;
...
LAB_00424410:
    ...
    *(short *)(value + 0x16) = shortValue;
    if (4 < shortValue) goto LAB_00424410;
  }
