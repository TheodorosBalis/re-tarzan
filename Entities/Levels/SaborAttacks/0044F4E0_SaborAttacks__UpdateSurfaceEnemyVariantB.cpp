...
// Address: 0x0044F4E0
// Label: SaborAttacks::UpdateSurfaceEnemyVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void SaborAttacks::UpdateSurfaceEnemyVariantB(int entry)

{
  ...
  if (resultFlag != '\0') {
    if (*(short *)(entry + 0x3e) < 1) goto LAB_0044f580;
