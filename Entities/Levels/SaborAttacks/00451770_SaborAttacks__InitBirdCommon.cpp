...
// Address: 0x00451770
// Label: SaborAttacks::InitBirdCommon
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void SaborAttacks::InitBirdCommon(int entry)
...
LAB_004517c2:
  ...
  *(undefined2 *)(entry + 0x4a) = 0;
  ...
  switch(localState2) {
  case 0:
    dataCursor = &g_SaborAttacksBirdScriptDesc_1CA0;
  ...
  case 2:
    ...
    goto LAB_00451962;
  case 3:
    dataCursor = &g_SaborAttacksBirdScriptDesc_1CB0;
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x6e8;
LAB_00451851:
...
LAB_00451962:
  ...
  case 0x10:
    ...
    value = CEntities::SetEntitySceneObjectScriptAttachment
                      (entry,&g_SaborAttacksBirdScriptDesc_1CD0);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 0x11:
    dataCursor = &g_SaborAttacksBirdScriptDesc_1CE0;
...
LAB_004519c0:
    ...
    *(short *)(value + 0x16) = shortValue;
    if (4 < shortValue) goto LAB_004519c0;
  }
