...
// Address: 0x0044F0B0
// Label: SaborAttacks::UpdateSurfaceEnemy
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void SaborAttacks::UpdateSurfaceEnemy(int entry)

{
  ...
  if (resultFlag2 != '\0') {
    if (*(short *)(entry + 0x3e) < 1) goto LAB_0044f17e;
...
LAB_0044f2c9:
  ...
  case 3:
    ...
    if (*(char *)(value4 + 0x75) == '\0') {
      if (0x400 < value2 - value) goto LAB_0044f2b5;
