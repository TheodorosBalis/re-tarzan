...
// Address: 0x00452620
// Label: SaborAttacks::InitPangolin
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void SaborAttacks::InitPangolin(int entry)
  ...
  *(uint *)(entry + 0x28) = *(uint *)(entry + 0x28) | 0x1000;
  if (value != 0) {
    ...
    *(undefined2 *)(value + 0x140) = 0;
    ...
    CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&g_SaborAttacksPangolinScriptDesc);
