...
// Address: 0x004520C0
// Label: SaborAttacks::InitProximityTakeoffBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void SaborAttacks::InitProximityTakeoffBird(int entry)

{
  ...
  SaborAttacks::InitBirdCommon(entry);
  ...
  if (value3 != 0) {
    ...
    if (value != 0) {
      *(code **)(value + 0xc) = SaborAttacks::BirdProximityTakeoffCallback;
