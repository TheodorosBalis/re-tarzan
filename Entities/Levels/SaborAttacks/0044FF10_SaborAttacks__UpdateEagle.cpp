...
// Address: 0x0044FF10
// Label: SaborAttacks::UpdateEagle
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void SaborAttacks::UpdateEagle(int entry)
...
LAB_0045011a:
    ...
    if (value6 < 0x32) goto LAB_0045011a;
    if (flagByte == 0) goto LAB_00450115;
  }
