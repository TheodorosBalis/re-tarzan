...
// Address: 0x0040A2C0
// Label: CampsiteCommotion::InitProjectileDropBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CampsiteCommotion::InitProjectileDropBird(int entry)

{
  ...
  *(uint *)(entry + 0x28) = *(uint *)(entry + 0x28) | 4;
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      *(code **)(value + 0xc) = CampsiteCommotion::BirdProjectileDropCallback;
