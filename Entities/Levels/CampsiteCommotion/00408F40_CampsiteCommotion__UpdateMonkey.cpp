...
// Address: 0x00408F40
// Label: CampsiteCommotion::UpdateMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CampsiteCommotion::UpdateMonkey(int entry)

{
  ...
  if (resultFlag2 != '\0') {
    if (*(short *)(entry + 0x3e) < 1) goto LAB_0040901b;
...
LAB_00409166:
  ...
  case 3:
    ...
    if (*(char *)(value4 + 0x75) == '\0') {
      if (0x400 < value2 - value) goto LAB_00409152;
