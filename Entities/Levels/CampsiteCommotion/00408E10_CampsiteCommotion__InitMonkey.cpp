...
// Address: 0x00408E10
// Label: CampsiteCommotion::InitMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CampsiteCommotion::InitMonkey(int entry)
  ...
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      ...
      *(undefined2 *)(value + 0x140) = 0x100;
      CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&g_CampsiteCommotionMonkeyScriptDesc);
    ...
    value2 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0x110);
    value3 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0x10f);
