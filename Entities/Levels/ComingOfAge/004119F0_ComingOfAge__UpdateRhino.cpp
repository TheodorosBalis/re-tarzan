...
// Address: 0x004119F0
// Label: ComingOfAge::UpdateRhino
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateRhino(int entry)

{
  ...
  if (value4 == 0) goto switchD_00411ba3_default;
