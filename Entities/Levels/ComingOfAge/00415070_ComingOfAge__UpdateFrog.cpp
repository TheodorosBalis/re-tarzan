...
// Address: 0x00415070
// Label: ComingOfAge::UpdateFrog
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateFrog(int entry)

{
  ...
  if (value3 == 0) goto LAB_0041524e;
  value2 = CEntities::FindEntityAttachmentByFlags(entry,0x400);
  if (value2 == 0) goto LAB_0041524e;
  ...
  if (shortValue != 1) {
    if (shortValue == 2) {
      if ((*(byte *)(entry + 0x4a) & 2) == 0) {
        ...
        *(int *)(value3 + 0x40) =
             *(int *)(&g_ComingOfAgeFrogHopVelocityTable + *(int *)(entry + 0x50) * 4) * -8;
...
LAB_004151cd:
    ...
    if (flagByte == 0) goto LAB_004151cd;
  }
