...
// Address: 0x0041FE00
// Label: ComingOfAge::UpdateChasingProjectileVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateChasingProjectileVariant(int entry)
...
LAB_00420061:
                ...
                if (0x17b < value) {
                  if (*(char *)(value5 + 0x75) == '\0') goto LAB_00420051;
                  goto LAB_00420061;
                }
                value6 = 10;
              }
...
LAB_0041ffa1:
              ...
              if (0x17b < value4 - value) {
                if (*(char *)(value5 + 0x75) == '\0') goto LAB_0041ff93;
                goto LAB_0041ffa1;
              }
              value6 = 10;
            }
