...
// Address: 0x0041C220
// Label: ComingOfAge::InitMonkeyVariantC
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::InitMonkeyVariantC(int entry)
  ...
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      ...
      *(undefined2 *)(value + 0x140) = 0x100;
      value2 = (int)CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004c46a8);
      if (value2 != 0) {
