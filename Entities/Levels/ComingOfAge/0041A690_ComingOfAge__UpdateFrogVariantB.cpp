...
// Address: 0x0041A690
// Label: ComingOfAge::UpdateFrogVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateFrogVariantB(int entry)

{
  ...
  if (value3 == 0) goto LAB_0041a86e;
  value2 = CEntities::FindEntityAttachmentByFlags(entry,0x400);
  if (value2 == 0) goto LAB_0041a86e;
  ...
  if (shortValue != 1) {
    if (shortValue == 2) {
      if ((*(byte *)(entry + 0x4a) & 2) == 0) {
        ...
        *(int *)(value3 + 0x40) =
             *(int *)(&g_ComingOfAgeFrogVariantBHopVelocityTable + *(int *)(entry + 0x50) * 4) *
             -8;
...
LAB_0041a7ed:
    ...
    if (flagByte == 0) goto LAB_0041a7ed;
  }
