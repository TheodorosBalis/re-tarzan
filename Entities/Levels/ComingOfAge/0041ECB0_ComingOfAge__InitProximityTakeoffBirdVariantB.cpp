...
// Address: 0x0041ECB0
// Label: ComingOfAge::InitProximityTakeoffBirdVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::InitProximityTakeoffBirdVariantB(int entry)

{
  ...
  ComingOfAge::InitBirdCommonVariantB(entry);
  ...
  if (value3 != 0) {
    ...
    if (value != 0) {
      *(code **)(value + 0xc) = ComingOfAge::TriggerBirdVariantBTakeoffWhenPlayerNear;
