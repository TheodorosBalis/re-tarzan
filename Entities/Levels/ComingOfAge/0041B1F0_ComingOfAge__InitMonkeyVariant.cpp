...
// Address: 0x0041B1F0
// Label: ComingOfAge::InitMonkeyVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::InitMonkeyVariant(int entry)

{
  ...
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    value2 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0x1e4);
    value3 = CEntities::CountEntitiesOfTypeInList(g_ActiveEntityListHead,0x1e1);
