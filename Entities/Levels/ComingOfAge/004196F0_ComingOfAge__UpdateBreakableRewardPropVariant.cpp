...
// Address: 0x004196F0
// Label: ComingOfAge::UpdateBreakableRewardPropVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateBreakableRewardPropVariant(int entry)
  ...
  case 1:
    ...
    *(int *)(entry + 0x4c) = value3;
    ...
    if (*(char *)(value2 + 0x75) == '\0') {
      if (400 < value5 - value4) goto LAB_004198d2;
...
LAB_004198d2:
      ...
      if (((int)value7 < 1) || (0x1c1 < (int)value7)) goto LAB_00419833;
      if (*(char *)(value2 + 0x75) != '\0') {
