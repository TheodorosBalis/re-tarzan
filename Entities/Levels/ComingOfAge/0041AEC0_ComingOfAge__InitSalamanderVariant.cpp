...
// Address: 0x0041AEC0
// Label: ComingOfAge::InitSalamanderVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::InitSalamanderVariant(int entry)

{
  ...
  if (value != 0) {
    ...
    *(undefined2 *)(value + 0xa0) = 0x400;
    CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004c41b0);
