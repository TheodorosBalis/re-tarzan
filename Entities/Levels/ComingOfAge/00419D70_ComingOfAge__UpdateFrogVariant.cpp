...
// Address: 0x00419D70
// Label: ComingOfAge::UpdateFrogVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateFrogVariant(int entry)
...
LAB_00419f7a:
    ...
    if (value6 < 0x32) goto LAB_00419f7a;
    if (flagByte == 0) goto LAB_00419f75;
  }
