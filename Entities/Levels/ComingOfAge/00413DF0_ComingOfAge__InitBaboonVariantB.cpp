...
// Address: 0x00413DF0
// Label: ComingOfAge::InitBaboonVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::InitBaboonVariantB(int entry)
  ...
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      ...
      *(undefined2 *)(value + 0x140) = 0;
      ...
      if (value != 0) {
        *(code **)(&((EntitySceneObject *)value)->worldObject) = ComingOfAge::UpdateBaboonVariantBStateMachine;
