...
// Address: 0x0041CA30
// Label: ComingOfAge::InitHogSpawnerVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::InitHogSpawnerVariantB(int entry)

{
  ...
  if (value != 0) {
    ((EntitySceneObject *)value)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x410;
