...
// Address: 0x0041CC30
// Label: ComingOfAge::UpdateHogVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateHogVariantB(int entry)
