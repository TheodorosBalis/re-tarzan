...
// Address: 0x00415590
// Label: ComingOfAge::UpdateMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateMonkey(int entry)

{
  ...
  if (resultFlag2 != '\0') {
    if (*(short *)(entry + 0x3e) < 1) goto LAB_0041565e;
...
LAB_004157a9:
  ...
  case 3:
    ...
    if (*(char *)(value4 + 0x75) == '\0') {
      if (0x400 < value2 - value) goto LAB_00415795;
