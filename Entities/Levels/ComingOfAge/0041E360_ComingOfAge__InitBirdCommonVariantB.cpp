...
// Address: 0x0041E360
// Label: ComingOfAge::InitBirdCommonVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::InitBirdCommonVariantB(int entry)
...
LAB_0041e441:
  ...
  case 4:
    ...
    value = (int)CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004c5848);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 5:
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x820;
    value = (int)CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004c5878);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 6:
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x750;
...
LAB_0041e552:
  ...
  case 0x10:
    ...
    value = (int)CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004c5888);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 0x11:
    dataCursor = &DAT_004c5898;
...
LAB_0041e5b0:
    ...
    *(short *)(value + 0x16) = shortValue;
    if (4 < shortValue) goto LAB_0041e5b0;
  }
