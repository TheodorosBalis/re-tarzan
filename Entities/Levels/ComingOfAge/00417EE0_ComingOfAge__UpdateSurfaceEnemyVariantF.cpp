...
// Address: 0x00417EE0
// Label: ComingOfAge::UpdateSurfaceEnemyVariantF
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateSurfaceEnemyVariantF(int entry)
...
LAB_00418141:
                ...
                if (0x17b < value) {
                  if (*(char *)(value5 + 0x75) == '\0') goto LAB_00418131;
                  goto LAB_00418141;
                }
                value6 = 10;
              }
...
LAB_00418081:
              ...
              if (0x17b < value4 - value) {
                if (*(char *)(value5 + 0x75) == '\0') goto LAB_00418073;
                goto LAB_00418081;
              }
              value6 = 10;
            }
