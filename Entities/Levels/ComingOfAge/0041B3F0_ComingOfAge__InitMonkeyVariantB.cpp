...
// Address: 0x0041B3F0
// Label: ComingOfAge::InitMonkeyVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::InitMonkeyVariantB(int entry)
  ...
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      ...
      *(undefined2 *)(value + 0x140) = 0x100;
      CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004c4688);
    ...
    value2 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0x1e5);
    value3 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0x1e4);
