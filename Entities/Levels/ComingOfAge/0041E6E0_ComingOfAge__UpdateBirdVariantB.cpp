...
// Address: 0x0041E6E0
// Label: ComingOfAge::UpdateBirdVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateBirdVariantB(int entry)
