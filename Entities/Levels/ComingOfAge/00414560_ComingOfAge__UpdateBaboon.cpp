...
// Address: 0x00414560
// Label: ComingOfAge::UpdateBaboon
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateBaboon(int entry)
...
LAB_004147c1:
                ...
                if (0x17b < value) {
                  if (*(char *)(value5 + 0x75) == '\0') goto LAB_004147b1;
                  goto LAB_004147c1;
                }
                value6 = 10;
              }
...
LAB_00414701:
              ...
              if (0x17b < value4 - value) {
                if (*(char *)(value5 + 0x75) == '\0') goto LAB_004146f3;
                goto LAB_00414701;
              }
              value6 = 10;
            }
