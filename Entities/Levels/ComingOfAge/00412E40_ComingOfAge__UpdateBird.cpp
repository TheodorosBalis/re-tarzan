...
// Address: 0x00412E40
// Label: ComingOfAge::UpdateBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateBird(int entry)
