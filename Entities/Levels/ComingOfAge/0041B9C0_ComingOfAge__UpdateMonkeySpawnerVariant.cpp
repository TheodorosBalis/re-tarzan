...
// Address: 0x0041B9C0
// Label: ComingOfAge::UpdateMonkeySpawnerVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateMonkeySpawnerVariant(int entry)

{
  ...
  if (resultFlag == '\0') {
    ...
    if (*(short *)(entry + 0x3e) < 1) goto LAB_0041ba69;
