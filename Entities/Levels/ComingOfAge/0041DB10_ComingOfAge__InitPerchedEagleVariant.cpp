...
// Address: 0x0041DB10
// Label: ComingOfAge::InitPerchedEagleVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::InitPerchedEagleVariant(int entry)

{
  ...
  if (value != 0) {
    ...
    *(undefined2 *)(value + 0xa0) = 0x400;
    CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004c5148);
