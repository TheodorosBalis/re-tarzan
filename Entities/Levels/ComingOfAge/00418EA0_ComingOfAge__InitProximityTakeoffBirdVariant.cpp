...
// Address: 0x00418EA0
// Label: ComingOfAge::InitProximityTakeoffBirdVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::InitProximityTakeoffBirdVariant(int entry)

{
  ...
  ComingOfAge::InitScriptedScenePropVariant(entry);
  ...
  if (value3 != 0) {
    ...
    if (value != 0) {
      *(code **)(value + 0xc) = ComingOfAge::TriggerBirdTakeoffWhenPlayerNear;
