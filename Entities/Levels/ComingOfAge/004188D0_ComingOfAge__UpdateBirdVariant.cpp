...
// Address: 0x004188D0
// Label: ComingOfAge::UpdateBirdVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateBirdVariant(int entry)
