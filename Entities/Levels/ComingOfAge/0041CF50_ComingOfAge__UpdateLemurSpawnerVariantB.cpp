...
// Address: 0x0041CF50
// Label: ComingOfAge::UpdateLemurSpawnerVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateLemurSpawnerVariantB(int entry)
  ...
  if ((value3 != 0) &&
    ...
    value2 = CEntities::SpawnEntityByTypeAtPosition
                      (((EntitySceneObject *)value3)->x,((EntitySceneObject *)value3)->y,
                       ((EntitySceneObject *)value3)->z,0x1ae,0x11);
    if (value2 != 0) {
      *(ushort *)(value2 + 0x4a) = *(ushort *)(value2 + 0x4a) | 0x100;
      if ((entity->descriptor != 0) &&
         ((*(ushort *)(*(int *)(entity->descriptor + 0x10) + 2) & 0x100) != 0)) {
        *(ushort *)(value2 + 0x4a) = *(ushort *)(value2 + 0x4a) | 0x80;
      }
