...
// Address: 0x0041D880
// Label: ComingOfAge::UpdateEagleVariant
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateEagleVariant(int entry)
...
LAB_0041da81:
  ...
  case 6:
    ...
    *(int *)(entry + 0x4c) = value4;
    if ((-1 < value4) || (resultFlag == '\0')) break;
switchD_0041d9b8_caseD_2:
    *(undefined2 *)(entry + 0x48) = 2;
  }
switchD_0041d962_default:
