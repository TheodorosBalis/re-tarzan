...
// Address: 0x00412AC0
// Label: ComingOfAge::InitBirdCommon
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::InitBirdCommon(int entry)
...
LAB_00412b12:
  ...
  *(undefined2 *)(entry + 0x4a) = 0;
  ...
  switch(localState2) {
  case 0:
    dataCursor = &g_ComingOfAgeBirdScriptAttachmentDesc_Variant0;
  ...
  case 2:
    ...
    goto LAB_00412cb2;
  case 3:
    dataCursor = &g_ComingOfAgeBirdScriptAttachmentDesc_Variant2;
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x6e8;
LAB_00412ba1:
...
LAB_00412cb2:
  ...
  case 0x10:
    ...
    value = CEntities::SetEntitySceneObjectScriptAttachment
                      (entry,&g_ComingOfAgeBirdScriptAttachmentDesc_Variant16);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 0x11:
    dataCursor = &g_ComingOfAgeBirdScriptAttachmentDesc_Variant17;
...
LAB_00412d10:
    ...
    *(short *)(value + 0x16) = shortValue;
    if (4 < shortValue) goto LAB_00412d10;
  }
