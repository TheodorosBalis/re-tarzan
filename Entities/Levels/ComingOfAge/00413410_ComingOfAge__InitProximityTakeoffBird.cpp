...
// Address: 0x00413410
// Label: ComingOfAge::InitProximityTakeoffBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::InitProximityTakeoffBird(int entry)

{
  ...
  ComingOfAge::InitBirdCommon(entry);
  ...
  if (value3 != 0) {
    ...
    if (value != 0) {
      *(code **)(value + 0xc) = ComingOfAge::BirdProximityTakeoffCallback;
