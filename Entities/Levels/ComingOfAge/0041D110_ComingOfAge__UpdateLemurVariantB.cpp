...
// Address: 0x0041D110
// Label: ComingOfAge::UpdateLemurVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateLemurVariantB(int entry)

{
  ...
  case 1:
    ...
    if ((*(byte *)(entry + 0x4a) & 0x80) == 0) {
      ...
      if ((value7 & 1) == 0) {
switchD_0041d2bc_caseD_2:
        *(undefined2 *)(entry + 0x48) = 2;
        break;
      }
switchD_0041d2bc_caseD_0:
      *(undefined2 *)(entry + 0x48) = 8;
      ...
      case 0:
      case 1:
        goto switchD_0041d2bc_caseD_0;
      case 2:
        goto switchD_0041d2bc_caseD_2;
      case 3:
      case 4:
      case 5:
      case 6:
  ...
  case 2:
    ...
    else if (500 < value - value2) goto LAB_0041d43a;
    *(undefined2 *)(entry + 0x48) = 0;
    break;
  case 3:
    if (value4 == 0) break;
