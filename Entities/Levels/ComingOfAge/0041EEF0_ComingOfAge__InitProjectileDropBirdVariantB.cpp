...
// Address: 0x0041EEF0
// Label: ComingOfAge::InitProjectileDropBirdVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::InitProjectileDropBirdVariantB(int entry)

{
  ...
  *(uint *)(entry + 0x28) = *(uint *)(entry + 0x28) | 4;
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      *(code **)(value + 0xc) = ComingOfAge::BirdVariantBProjectileDropCallback;
