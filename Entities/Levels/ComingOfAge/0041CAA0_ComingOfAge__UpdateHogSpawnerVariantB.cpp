...
// Address: 0x0041CAA0
// Label: ComingOfAge::UpdateHogSpawnerVariantB
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::UpdateHogSpawnerVariantB(int entry)
  ...
  if ((value3 != 0) &&
    ...
    value2 = CEntities::SpawnEntityByTypeAtPosition
                      (((EntitySceneObject *)value3)->x,((EntitySceneObject *)value3)->y,
                       ((EntitySceneObject *)value3)->z,0x1ac,0x11);
    if (value2 != 0) {
        ...
        *(undefined4 *)(value + 0x10c) = ((EntitySceneObject *)value3)->surfaceIndex;
        ...
        if (entity->descriptor != 0) {
          CEntities::ApplyConfiguredEntitySceneObjectScale
                    (value,*(undefined4 *)(*(int *)(entity->descriptor + 0x10) + 8));
        }
      }
    }
