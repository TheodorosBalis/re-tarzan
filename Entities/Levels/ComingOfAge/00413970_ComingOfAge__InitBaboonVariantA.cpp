...
// Address: 0x00413970
// Label: ComingOfAge::InitBaboonVariantA
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void ComingOfAge::InitBaboonVariantA(int entry)
  ...
  *(uint *)(entry + 0x28) = *(uint *)(entry + 0x28) | 0x1004;
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      ...
      CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_004c2168);
      value = ComingOfAge::InitBaboonVariantStateAttachment(entry);
      if (value != 0) {
        *(code **)(&((EntitySceneObject *)value)->worldObject) = ComingOfAge::UpdateBaboonVariantAStateMachine;
      }
    }
