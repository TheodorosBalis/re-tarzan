...
// Address: 0x0047DBD0
// Label: JourneyToTheTreeHouse::UpdateCollapsingPlatform
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void JourneyToTheTreeHouse::UpdateCollapsingPlatform(int entry)

{
  ...
  flagByte = *(byte *)(entry + 0x3d);
  value4 = entity->sceneObjects;
  value = (uint)flagByte * 0x24;
  dataCursor = (undefined4 *)(&g_JourneyToTheTreeHouseCollapsingPlatformConfigTable + value);
  if (*(short *)(entry + 0x48) == 1) {
    ...
    if (shortValue == 0) {
      ...
      *(uint *)(value4 + *(int *)(&DAT_00504bb0 + value) * 0x1c + 0x44) =
           *(uint *)(value4 + 0x44 + *(int *)(&DAT_00504bb0 + value) * 0x1c) & 0xffffff7f | 0x100;
    ...
    if (*(short *)(entry + 0x48) == 2) {
      *(short *)(value4 + 0xa0) = *(short *)(value4 + 0xa0) + *(short *)(&DAT_00504bca + value);
      ((EntitySceneObject *)value4)->pitch = ((EntitySceneObject *)value4)->pitch + *(short *)(&DAT_00504bcc + value);
      *(short *)(entry + 0x4a) = *(short *)(entry + 0x4a) + 6;
      ((EntitySceneObject *)value4)->y = ((EntitySceneObject *)value4)->y + (uint)*(ushort *)(entry + 0x4a);
      goto LAB_0047dd41;
    }
    if ((*(byte *)(entry + 0x42) & 0x80) == 0) goto LAB_0047dd41;
    shortValue = *(short *)(entry + 0x4a);
    if (shortValue == 0) {
      ...
      *(undefined **)(&((EntitySceneObject *)value4)->y) =
           (&PTR_JourneyToTheTreeHouse__InitLevelRuntimeHook_00504bbc)[(uint)flagByte * 9] +
           ((EntitySceneObject *)value4)->y;
      *(undefined2 *)(entry + 0x4a) = *(undefined2 *)(&DAT_00504bc8 + value);
      value2 = ResolveCollisionSurfaceIndexByCoordRef(*dataCursor);
      value4 = g_CollisionSurfaceTable + 4;
      value3 = ResolveCollisionSurfaceIndexByCoordRef(*dataCursor);
      intCursor = (int *)(g_CollisionSurfaceTable + value3 * 4 + *(int *)(value4 + value2 * 4) +
                       *(int *)(&DAT_00504bb0 + value) * 0x1c + 0x38);
      *intCursor = *intCursor + *(int *)(&DAT_00504bb8 + value);
