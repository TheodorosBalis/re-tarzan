...
// Address: 0x0047CB70
// Label: JourneyToTheTreeHouse::UpdateMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void JourneyToTheTreeHouse::UpdateMonkey(int entry)

{
  ...
  if (resultFlag2 != '\0') {
    if (*(short *)(entry + 0x3e) < 1) goto LAB_0047cc4b;
...
LAB_0047cd96:
  ...
  case 3:
    ...
    if (*(char *)(value4 + 0x75) == '\0') {
      if (0x400 < value2 - value) goto LAB_0047cd82;
