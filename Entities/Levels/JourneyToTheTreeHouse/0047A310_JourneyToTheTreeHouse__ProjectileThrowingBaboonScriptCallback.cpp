...
// Address: 0x0047A310
// Label: JourneyToTheTreeHouse::ProjectileThrowingBaboonScriptCallback
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void JourneyToTheTreeHouse::ProjectileThrowingBaboonScriptCallback
...

{
  ...
  case 1:
    ...
    *(int *)(arg1 + 0x4c) = value2;
    if (value < 0x7d1) {
      if (value < 500) goto LAB_0047a3ff;
      if (value2 < 0x23) {
