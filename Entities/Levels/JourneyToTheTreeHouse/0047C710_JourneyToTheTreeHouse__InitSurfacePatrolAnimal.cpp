...
// Address: 0x0047C710
// Label: JourneyToTheTreeHouse::InitSurfacePatrolAnimal
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void JourneyToTheTreeHouse::InitSurfacePatrolAnimal(int entry)
  ...
  if (value != 0) {
    ...
    *(undefined2 *)(value + 0xa0) = 0x400;
    CEntities::SetEntitySceneObjectScriptAttachment
              (entry,&g_JourneyToTheTreeHouseSurfacePatrolAnimalScriptAttachmentDesc);
