...
// Address: 0x0047B4D0
// Label: JourneyToTheTreeHouse::InitBirdCommon
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void JourneyToTheTreeHouse::InitBirdCommon(int entry)
...
LAB_0047b5b1:
  ...
  case 4:
    ...
    value = (int)CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_0050d170);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 5:
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x820;
    value = (int)CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_0050d1a0);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 6:
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x750;
...
LAB_0047b6c2:
  ...
  case 0x10:
    ...
    value = (int)CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&DAT_0050d1b0);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 0x11:
    dataCursor = &DAT_0050d1c0;
...
LAB_0047b720:
    ...
    *(short *)(value + 0x16) = shortValue;
    if (4 < shortValue) goto LAB_0047b720;
  }
