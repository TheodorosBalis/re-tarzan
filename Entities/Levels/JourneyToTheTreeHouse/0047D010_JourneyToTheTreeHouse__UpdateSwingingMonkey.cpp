...
// Address: 0x0047D010
// Label: JourneyToTheTreeHouse::UpdateSwingingMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void JourneyToTheTreeHouse::UpdateSwingingMonkey(int entry)

{
  ...
  if (resultFlag == '\0') {
    ...
    if (*(short *)(entry + 0x3e) < 1) goto LAB_0047d0b9;
