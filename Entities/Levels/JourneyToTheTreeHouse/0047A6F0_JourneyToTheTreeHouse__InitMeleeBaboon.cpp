...
// Address: 0x0047A6F0
// Label: JourneyToTheTreeHouse::InitMeleeBaboon
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void JourneyToTheTreeHouse::InitMeleeBaboon(int entry)
  ...
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      ...
      *(undefined2 *)(value + 0x140) = 0;
      ...
      if (value != 0) {
        *(code **)(&((EntitySceneObject *)value)->worldObject) = JourneyToTheTreeHouse::MeleeBaboonScriptCallback;
