...
// Address: 0x0047BE20
// Label: JourneyToTheTreeHouse::InitProximityTakeoffBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void JourneyToTheTreeHouse::InitProximityTakeoffBird(int entry)

{
  ...
  JourneyToTheTreeHouse::InitBirdCommon(entry);
  ...
  if (value3 != 0) {
    ...
    if (value != 0) {
      *(code **)(value + 0xc) = JourneyToTheTreeHouse::BirdProximityTakeoffCallback;
