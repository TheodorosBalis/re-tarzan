...
// Address: 0x0047D980
// Label: JourneyToTheTreeHouse::UpdateBreakableRewardProp
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void JourneyToTheTreeHouse::UpdateBreakableRewardProp(int entry)
    ...
    if (*(short *)(entry + 0x4a) == 0) {
      if (resultFlag != '\0') {
        ...
        *(undefined2 *)(entry + 0x4a) = 1;
        value2 = *(int *)(&g_JourneyToTheTreeHouseBreakableRewardSpawnSequenceTable +
          ...
          *(int *)(&g_BreakableRewardSpawnCounter0 + value3 * 4) =
          ...
          CEntities::SpawnMappedEffectOnSurfaceWithScatterConfig
                    (value2,((EntitySceneObject *)value)->surfacePathIndex,((EntitySceneObject *)value)->surfaceIndex,
                     &g_JourneyToTheTreeHouseBreakableRewardSpawnOffsetTable);
          *(int *)(&g_BreakableRewardSpawnCounter0 + value3 * 4) =
               *(int *)(&g_BreakableRewardSpawnCounter0 + value3 * 4) + 1;
        }
      }
      ...
      if (value3 < 0) {
        ...
        *(int *)(value + 0xa8) =
             *(int *)(value + 0xa8) -
             (int)*(short *)(&g_JourneyToTheTreeHouseBreakableRewardScaleDeltaTable + value3 * 2);
        *(int *)(value + 0xac) =
             *(int *)(value + 0xac) +
             (int)*(short *)(&g_JourneyToTheTreeHouseBreakableRewardScaleDeltaTable + value3 * 2);
        *(int *)(value + 0xb0) =
