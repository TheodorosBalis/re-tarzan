...
// Address: 0x00486350
// Label: TrashingTheCamp::UpdateSwingingMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void TrashingTheCamp::UpdateSwingingMonkey(int entry)

{
  ...
  if (resultFlag == '\0') {
    ...
    if (*(short *)(entry + 0x3e) < 1) goto LAB_004863f9;
