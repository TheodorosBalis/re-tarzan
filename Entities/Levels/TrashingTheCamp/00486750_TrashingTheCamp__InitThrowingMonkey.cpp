...
// Address: 0x00486750
// Label: TrashingTheCamp::InitThrowingMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void TrashingTheCamp::InitThrowingMonkey(int entry)

{
  ...
  *(uint *)(entry + 0x28) = *(uint *)(entry + 0x28) | 0x1004;
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    value2 = CEntities::CountEntitiesOfTypeInList(g_ActiveEntityListHead,0xf2);
    if (value + value2 < 2) {
