...
// Address: 0x00488BE0
// Label: TrashingTheCamp::InitCampCollapseEmitter
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void TrashingTheCamp::InitCampCollapseEmitter(int entry)
