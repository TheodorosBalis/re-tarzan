...
// Address: 0x00485D80
// Label: TrashingTheCamp::InitMonkey
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void TrashingTheCamp::InitMonkey(int entry)
  ...
  if ((*(byte *)(entry + 0x43) & 0x80) == 0) {
    ...
    if (value != 0) {
      ...
      *(undefined2 *)(value + 0x140) = 0x100;
      CEntities::SetEntitySceneObjectScriptAttachment(entry,(uint *)&g_TrashingTheCampMonkeyScriptDesc);
    ...
    value2 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0xf6);
    value3 = CEntities::CountEntitiesOfTypeInList(g_LevelEnemyEntityListHead,0xf3);
