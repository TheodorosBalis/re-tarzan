...
// Address: 0x00484C50
// Label: TrashingTheCamp::UpdateBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void TrashingTheCamp::UpdateBird(int entry)
