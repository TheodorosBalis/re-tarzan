...
// Address: 0x004848D0
// Label: TrashingTheCamp::InitBirdCommon
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void TrashingTheCamp::InitBirdCommon(int entry)
...
LAB_00484922:
  ...
  *(undefined2 *)(entry + 0x4a) = 0;
  ...
  switch(localState2) {
  case 0:
    dataCursor = &g_TrashingTheCampBirdScriptDesc_1CA0;
  ...
  case 2:
    ...
    goto LAB_00484ac2;
  case 3:
    dataCursor = &g_TrashingTheCampBirdScriptDesc_1CB0;
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x6e8;
LAB_004849b1:
...
LAB_00484ac2:
  ...
  case 0x10:
    ...
    value = CEntities::SetEntitySceneObjectScriptAttachment
                      (entry,&g_TrashingTheCampBirdScriptDesc_1CD0);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 0x11:
    dataCursor = &g_TrashingTheCampBirdScriptDesc_1CE0;
...
LAB_00484b20:
    ...
    *(short *)(value + 0x16) = shortValue;
    if (4 < shortValue) goto LAB_00484b20;
  }
