...
// Address: 0x00487CE0
// Label: TrashingTheCamp::InitRunningGorillaA
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void TrashingTheCamp::InitRunningGorillaA(int entry)

{
  ...
  if (value != 0) {
    ...
    PlayAudioById(0x2ab,(int *)&((EntitySceneObject *)value)->soundPosition,(undefined4 *)&((EntitySceneObject *)value)->x);
  }
