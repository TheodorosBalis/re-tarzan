...
// Address: 0x004596B0
// Label: Stampede::InitBirdCommon
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void Stampede::InitBirdCommon(int entry)
...
LAB_00459702:
  ...
  *(undefined2 *)(entry + 0x4a) = 0;
  ...
  switch(localState2) {
  case 0:
    dataCursor = &g_StampedeBirdScriptAttachmentDescB;
  ...
  case 2:
    ...
    goto LAB_004598a2;
  case 3:
    dataCursor = &g_StampedeBirdScriptAttachmentDescC;
    ((EntitySceneObject *)value2)->worldObject = g_WorldEntitySceneObjectArrayBase + 0x6e8;
LAB_00459791:
...
LAB_004598a2:
  ...
  case 0x10:
    ...
    value = CEntities::SetEntitySceneObjectScriptAttachment
                      (entry,&g_StampedeBirdScriptAttachmentDescE);
    *(byte *)(entry + 0x4a) = *(byte *)(entry + 0x4a) | 0x10;
    break;
  case 0x11:
    dataCursor = &g_StampedeBirdScriptAttachmentDescF;
...
LAB_00459900:
    ...
    *(short *)(value + 0x16) = shortValue;
    if (4 < shortValue) goto LAB_00459900;
  }
