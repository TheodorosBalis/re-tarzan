...
void WelcomeToTheJungle__SpawnLemursOnPath(int param_1)

{
  ...
  if ((iVar4 != 0) &&
    ...
    iVar3 = CEntities__SpawnRuntimeEntryByTypeAtPosition
                       ...
                       *(undefined4 *)(iVar4 + 0x1c),0x3e,0x11);
    if (iVar3 != 0) {
      *(ushort *)(iVar3 + 0x4a) = *(ushort *)(iVar3 + 0x4a) | 0x100;
      if ((*(int *)(param_1 + 0x34) != 0) &&
         ((*(ushort *)(*(int *)(*(int *)(param_1 + 0x34) + 0x10) + 2) & 0x100) != 0)) {
        *(ushort *)(iVar3 + 0x4a) = *(ushort *)(iVar3 + 0x4a) | 0x80;
      }
