...

{
  ...
  do {
    ...
    if (WindowHandlerValue1 == 1) {
      WindowHandlerValue1 = 0;
    }
    ReadUserInput1();
    iVar3 = FUN_0049c6a0();
    if (iVar3 != 0) {
...
LAB_004aee78:
          FUN_0049e8b0(pcVar10,&cStack_100);
        }
        break;
      case 2:
        if (DAT_00724ed0 == 0) {
    ...
    SetIsWindowActive();
    if ((WindowHandlerValue1 == 0) || (WindowInactive != 0)) {
      WaitMessage();
    }
    if (((WindowHandlerValue1 != 0) && (WindowInactive == 0)) && (WindowHandlerValue3 == 0)) {
