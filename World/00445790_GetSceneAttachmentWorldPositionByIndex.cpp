...
// Address: 0x00445790
// Label: GetSceneAttachmentWorldPositionByIndex
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

int GetSceneAttachmentWorldPositionByIndex(int arg1,int *arg2,int arg3)

{
  ...
  if (entry != 0) {
    ...
    *arg2 = *(int *)(arg1 + 0x14) + (int)localState3;
    arg2[1] = *(int *)(arg1 + 0x18) + (int)localState2;
    arg2[2] = *(int *)(arg1 + 0x1c) + (int)localState;
    return entry;
  }
  return 0;
}
