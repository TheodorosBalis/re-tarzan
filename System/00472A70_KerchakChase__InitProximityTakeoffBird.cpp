...
// Address: 0x00472A70
// Label: KerchakChase::InitProximityTakeoffBird
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void KerchakChase::InitProximityTakeoffBird(int entry)

{
  ...
  KerchakChase::InitBirdCommon(entry);
  ...
  if (value3 != 0) {
    ...
    if (value != 0) {
      *(code **)(value + 0xc) = KerchakChase::TriggerBirdTakeoffWhenPlayerNear;
