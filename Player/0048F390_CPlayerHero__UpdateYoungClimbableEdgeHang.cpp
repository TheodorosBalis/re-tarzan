...
// Address: 0x0048F390
// Label: CPlayerHero::UpdateYoungClimbableEdgeHang
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CPlayerHero::UpdateYoungClimbableEdgeHang(void)

{
  ...
  if (((g_PlayerSequenceFlags & 0xf000) == 0) &&
    ...
    g_PreviousPlayerActionState = value;
                    /* WARNING: Could not recover jumptable at 0x0048f3c9. Too many branches */
  ...
  if (((g_PlayerSequenceFlags & 0xf000) == 0) && ((g_PlayerInputPressedMask & 0x200000) != 0)) {
    ...
    g_PreviousPlayerActionState = value;
                    /* WARNING: Could not recover jumptable at 0x0048f3f5. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)g_YoungEnterClimbableSurfaceJumpOffHandlerPtr)();
    return;
  }
