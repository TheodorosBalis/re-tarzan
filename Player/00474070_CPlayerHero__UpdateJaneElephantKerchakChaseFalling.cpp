...
// Address: 0x00474070
// Label: CPlayerHero::UpdateJaneElephantKerchakChaseFalling
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

uint CPlayerHero::UpdateJaneElephantKerchakChaseFalling(void)

{
  ...
  if (400 < *(int *)(g_PlayerEntitySceneObject + 0x18)) {
    g_HudCountdownBcdTime = 0;
    *( undefined2 *)((int)&g_LevelTransitionRequestFlags + 0) = 0x8001;
    value8 = SetHudCountdownDisplay(0,0x8000);
    return value8;
  }
