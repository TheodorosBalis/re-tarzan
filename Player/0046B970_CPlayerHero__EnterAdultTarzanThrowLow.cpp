...
// Address: 0x0046B970
// Label: CPlayerHero::EnterAdultTarzanThrowLow
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CPlayerHero::EnterAdultTarzanThrowLow(void)

{
  g_PlayerThrowLowArcSelected = 1;
  ...
  *(undefined1 *)(g_PlayerMotionState + 0xd) = 0;
  CPlayerHero::PlayAdultTarzanAnimation(0x7d);
