...
// Address: 0x0045BD10
// Label: CPlayerHero::EnterStorkGroundedRecoveryWait
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CPlayerHero::EnterStorkGroundedRecoveryWait(void)

{
  ...
  *(undefined **)(g_PlayerAnimationState + 0xc) = g_StorkGroundedRecoveryAnimationScript;
