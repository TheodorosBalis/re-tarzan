...
// Address: 0x004911E0
// Label: CPlayerHero::EnterYoungFatalDamageSequence
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CPlayerHero::EnterYoungFatalDamageSequence(void)

{
  ...
  if (value != 0) {
    ...
    *(int *)(value + 0x10) = g_WorldEntitySceneObjectArrayBase + 0x1a0;
  ...
  CPlayerHero::PlayAnimation(0x22);
