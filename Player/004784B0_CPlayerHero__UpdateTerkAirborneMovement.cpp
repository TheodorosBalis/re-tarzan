...
// Address: 0x004784B0
// Label: CPlayerHero::UpdateTerkAirborneMovement
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint CPlayerHero::UpdateTerkAirborneMovement(void)

{
  ...
  value5 = TryStartPlayerAttachmentInteraction();
  if ((char)value5 != '\0') {
    return value5;
  }
  ...
  if (g_PlayerJumpArcActive != '\0') {
    ...
    CPlayerHero::UpdateJumpArcVerticalMotion(g_PlayerActionState != 7);
  }
  value5 = 0;
    ...
    if ((*(byte *)(g_PlayerAnimationState + 0x1f) & 1) == 0) {
      do {
        *(short *)(g_PlayerAnimationState + 0x16) = *(short *)(g_PlayerAnimationState + 0x16) + 1;
        ...
        value6 = *(ushort *)(value3 + value * 4);
        value7 = value6 & 0x8000;
        if (value7 == 0) break;
        switch(value6) {
        case 0x8000:
        ...
        case 0x8003:
          value5 = (uint)*(ushort *)(value3 + 2 + value * 4);
          break;
        case 0x8004:
          ...
          return value5;
        case 0x8005:
          value5 = CPlayerHero::PlayHeroModeAnimation
                            (*(undefined2 *)
                              (*(int *)(g_PlayerAnimationState + 0xc) + 2 +
                              *(short *)(g_PlayerAnimationState + 0x16) * 4));
          return value5;
...
LAB_0043370d:
      ...
      if ((*(byte *)(g_PlayerAnimationState + 0x1e) & 4) == 0) {
        *g_PlayerEntitySceneObjectData = value6;
      }
      else {
        *(ushort *)(g_PlayerEntitySceneObject + 0x76) = value6;
      }
      ...
      *(short *)(g_PlayerAnimationState + 0x16) = *(short *)(g_PlayerAnimationState + 0x16) + -1;
      ...
      while (-1 < shortValue) {
        value6 = *(ushort *)(*(int *)(g_PlayerAnimationState + 0xc) + shortValue * 4);
        if ((value6 & 0x8000) == 0) {
          *g_PlayerEntitySceneObjectData = value6;
          *(undefined2 *)(g_PlayerAnimationState + 0x14) =
               *(undefined2 *)
