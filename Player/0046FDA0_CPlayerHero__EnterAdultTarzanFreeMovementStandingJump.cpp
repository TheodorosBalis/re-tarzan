...
// Address: 0x0046FDA0
// Label: CPlayerHero::EnterAdultTarzanFreeMovementStandingJump
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CPlayerHero::EnterAdultTarzanFreeMovementStandingJump(void)

{
  ...
  CPlayerHero::PlayAdultTarzanAnimation(0xd);
