...
// Address: 0x0046E890
// Label: UpdatePlayerSwingingMode1
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void UpdatePlayerSwingingMode1(void)
    ...
    if (value != 0) {
      ...
      *(undefined2 *)(value + 0xe) = 2;
      ...
      if ((g_PreviousPlayerActionState < 7) ||
         ((8 < g_PreviousPlayerActionState && (g_PreviousPlayerActionState != 0x16)))) {
        ...
        PlayAudioById(0x52,(int *)0,(undefined4 *)0);
      }
      else {
