...
// Address: 0x0048F600
// Label: CPlayerHero::UpdateYoungClimbableSurfaceJumpOff
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CPlayerHero::UpdateYoungClimbableSurfaceJumpOff(void)

{
  ...
  if (resultFlag != '\0') {
    ...
    g_PreviousPlayerActionState = value2;
                    /* WARNING: Could not recover jumptable at 0x0048f725. Too many branches */
