...
// Address: 0x0046A5C0
// Label: CPlayerHero::UpdateAdultTarzanFastForwardLaunch
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

uint CPlayerHero::UpdateAdultTarzanFastForwardLaunch(void)
    ...
    if ((*(byte *)(g_PlayerAnimationState + 0x1f) & 1) == 0) {
      do {
        *(short *)(g_PlayerAnimationState + 0x16) = *(short *)(g_PlayerAnimationState + 0x16) + 1;
        ...
        case 0x8003:
          value7 = (uint)*(ushort *)(value + 2 + value2 * 4);
          break;
        case 0x8004:
          ...
          return value7;
        case 0x8005:
          value7 = CPlayerHero::PlayHeroModeAnimation
                            (*(undefined2 *)
                              (*(int *)(g_PlayerAnimationState + 0xc) + 2 +
                              *(short *)(g_PlayerAnimationState + 0x16) * 4));
          return value7;
        case 0x8006:
          value4 = *(ushort *)(value + 2 + value2 * 4);
          if (value4 == 0x8000) {
