...
// Address: 0x00456470
// Label: CPlayerHero::EnterStampedeDamageRecoilTowardNegativeX
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void CPlayerHero::EnterStampedeDamageRecoilTowardNegativeX(void)

{
  ...
  *(undefined4 *)(g_PlayerMotionState + 0x18) = 0x200;
  ...
  g_StampedeLateralRecoilTargetSpeed = 0xfffff000;
