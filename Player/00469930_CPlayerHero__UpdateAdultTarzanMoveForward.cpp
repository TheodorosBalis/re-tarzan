...
// Address: 0x00469930
// Label: CPlayerHero::UpdateAdultTarzanMoveForward
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void CPlayerHero::UpdateAdultTarzanMoveForward(void)

{
  ...
  if (g_PlayerCurrentCollisionMode != 2) {
    ...
    CPlayerHero::UpdateAdultTarzanFreeMovementForward();
    return;
  }
  ...
  if (((_g_PlayerSequenceFlags & 0xf000) == 0) && (g_PendingAdultTarzanActionState != 0)) {
    g_PlayerCurrentAnimationId = 4;
    g_PreviousPlayerActionState = g_PlayerActionState;
    g_PlayerActionState = g_PendingAdultTarzanActionState;
    (*(code *)(&g_AdultTarzanActionStateEnterColumn)[(uint)g_PendingAdultTarzanActionState * 2])();
