...
// Address: 0x0046C8D0
// Label: CPlayerHero::UpdateAdultTarzanClimbableSurfaceJumpOff
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

void CPlayerHero::UpdateAdultTarzanClimbableSurfaceJumpOff(void)

{
  ...
  if (resultFlag != '\0') {
    ...
    g_PreviousPlayerActionState = value2;
                    /* WARNING: Could not recover jumptable at 0x0046c9f1. Too many branches */
