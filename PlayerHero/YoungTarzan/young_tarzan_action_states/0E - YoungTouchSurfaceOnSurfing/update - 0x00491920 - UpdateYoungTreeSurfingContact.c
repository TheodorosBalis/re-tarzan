/*
State 0x0E Update: CPlayerHero::UpdateYoungTreeSurfingContact
Address: 0x00491920
*/
...

{
  ...
  iVar3 = g_PlayerTreeSurfingLateralThresholdSide;
  ...
  *(undefined4 *)(g_PlayerSceneEntry + 0xac) = *(undefined4 *)(g_PlayerSceneEntry + 0xb0);
  ...
  case 0xe:
    cVar2 = CPlayerHero_TryHandleYoungTreeSurfingHazardCue1To4(uVar4);
    if (((cVar2 != '\0') ||
        (cVar2 = CPlayerHero_TryHandleYoungTreeSurfingHazardCue5To7(uVar4), cVar2 != '\0')) ||
       (cVar2 = CPlayerHero_TryHandleYoungTreeSurfingDamageCue8To10(uVar4),
       uVar1 = g_PlayerActionState, cVar2 != '\0')) goto LAB_00491dfb;
    if (DAT_0051cd1c != '\0') {
...
LAB_00491ae2:
    ...
    CPlayerHero_UpdateYoungTreeSurfingLateralOffset();
    uVar1 = g_PlayerActionState;
    ...
    if (iVar3 != g_PlayerTreeSurfingLateralThresholdSide) {
      ...
      CPlayerHero_PlayAnimation(uVar5);
    }
  ...
  case 0xf:
    cVar2 = CPlayerHero_TryHandleYoungTreeSurfingHazardCue1To4(uVar4);
    if ((cVar2 != '\0') ||
       (cVar2 = CPlayerHero_TryHandleYoungTreeSurfingHazardCue5To7(uVar4),
       uVar1 = g_PlayerActionState, cVar2 != '\0')) goto LAB_00491dfb;
    if (DAT_0051cd1c != '\0') {
      if ((ram0x0051cdca & 0x1000) == 0) {
        if (g_PlayerDamageInvulnerabilityTicks != 0) {
...
LAB_00491dcd:
  ...
  case 0x10:
    cVar2 = CPlayerHero_TryHandleYoungTreeSurfingHazardCue5To7(uVar4);
    if (cVar2 == '\0') {
      CPlayerHero_TryHandleYoungTreeSurfingDamageCue8To10(uVar4);
    }
  default:
    goto LAB_00491dfb;
  case 0x12:
