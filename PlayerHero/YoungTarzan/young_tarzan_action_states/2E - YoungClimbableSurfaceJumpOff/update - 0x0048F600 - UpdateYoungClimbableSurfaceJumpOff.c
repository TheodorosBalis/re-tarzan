/*
State 0x2E Update: CPlayerHero::UpdateYoungClimbableSurfaceJumpOff
Address: 0x0048F600
*/
...

{
  ...
  if (iVar3 == 8) {
    ...
    *(undefined1 *)(g_PlayerMotionState + 0xd) = 0;
    ...
    iVar3 = *(int *)(g_JungleSurfaceTableBase + 4 + uVar4 * 4) + 0x34 +
            ((uint)*(ushort *)(g_PlayerLatchedInteractionCollisionSurface + 0x1a) * 7 + uVar4) * 4 +
            g_JungleSurfaceTableBase;
  ...
  cVar2 = CPlayerHero_TryResolveGroundContactSnap();
