/*
State 0x33 Enter: CPlayerHero::EnterYoungThrowLow
Address: 0x0048EBD0
Source: C:\Users\Proxi\TarzanREVERSEDCodex\ghidra_export\young_state_forced_all_decomp\0048EBD0_CPlayerHero__EnterYoungThrowLow.c
*/


void CPlayerHero__EnterYoungThrowLow(void)

{
  ...
  *(undefined1 *)(g_PlayerMotionState + 0xd) = 0;
  CPlayerHero__PlayAnimation(0x89);
