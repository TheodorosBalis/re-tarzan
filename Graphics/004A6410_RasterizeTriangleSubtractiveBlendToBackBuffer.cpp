...
// Address: 0x004A6410
// Label: RasterizeTriangleSubtractiveBlendToBackBuffer
              ...
              if (value7 != 0) {
                ...
                *g_RasterizerCurrentPixelPtr =
                     ...
                     (ushort)*(byte *)((g_RasterizerCurrentShadeGreen >> 0x13 | (value7 & 0x7c0) >> 1
                                       | (value9 & 0x7c0) << 4) + g_Subtractive5BitBlendLookupTable))
