...

{
  ...
  CMenu::LevelComplete_SetSceneEntryTripletBatch(&g_LevelCompleteScoreSceneEntries,1,0x13e8);
  CMenu::LevelComplete_SetSceneEntryTripletBatch(&g_LevelCompleteCounterSceneEntries,4,0x380);
  ...
  CMenu::LevelComplete_SetSceneEntryTripletBatch(0x538afc,1,0x35c);
  CMenu::LevelComplete_SetSceneEntryTripletBatch(0x538c40,4,0x380);
  ...
  if (((ram0x00534026 & 0x8000) == 0) || (FadeBrightness == 0)) {
    ...
    if (g_LevelCompleteInputMode == 0) {
      iVar4 = 0;
      do {
        CMenu::LevelComplete_UpdateTARZANSlots(iVar4);
        iVar4 = iVar4 + 1;
      } while (iVar4 < 6);
      CMenu::LevelComplete_SetSceneEntryTripletBatch(&g_LevelCompleteRewardBurstScenes,4,0x800);
      _DAT_00539d0c =
    ...
    case 3:
      ...
      CMenu::LevelComplete_SetRewardBurstSlotState(iVar4);
      if (g_LevelCompleteFastForwardRequested == 0) {
        if (g_LevelCompleteStateTimer != 0) {
          return;
        }
