...
undefined4 * memmove(undefined4 *arg1,undefined4 *arg2,uint arg3)

{
  ...
  if ((arg2 < arg1) && (arg1 < (undefined4 *)(arg3 + (int)arg2))) {
    ...
    if (((uint)dataCursor & 3) == 0) {
      ...
      if (7 < value) {
        ...
        case 0:
          return arg1;
        case 2:
          goto switchD_004afc87_caseD_2;
        case 3:
          goto switchD_004afc87_caseD_3;
        }
        goto switchD_004afc87_caseD_1;
      }
    }
    else {
      switch(arg3) {
      case 0:
        goto switchD_004afc87_caseD_0;
      case 1:
        goto switchD_004afc87_caseD_1;
      case 2:
        goto switchD_004afc87_caseD_2;
    ...
    switch(arg3) {
    case 1:
switchD_004afc87_caseD_1:
      *(undefined1 *)((int)dataCursor + 3) = *(undefined1 *)((int)arg2 + 3);
      return arg1;
    case 2:
switchD_004afc87_caseD_2:
      *(undefined1 *)((int)dataCursor + 3) = *(undefined1 *)((int)arg2 + 3);
      *(undefined1 *)((int)dataCursor + 2) = *(undefined1 *)((int)arg2 + 2);
      return arg1;
    case 3:
switchD_004afc87_caseD_3:
      *(undefined1 *)((int)dataCursor + 3) = *(undefined1 *)((int)arg2 + 3);
      *(undefined1 *)((int)dataCursor + 2) = *(undefined1 *)((int)arg2 + 2);
      *(undefined1 *)((int)dataCursor + 1) = *(undefined1 *)((int)arg2 + 1);
      return arg1;
    }
switchD_004afc87_caseD_0:
    return arg1;
  }
  dataCursor = arg1;
  if (((uint)arg1 & 3) == 0) {
    ...
    if (7 < value) {
      ...
      case 0:
        return arg1;
      case 2:
        goto switchD_004afb05_caseD_2;
      case 3:
        goto switchD_004afb05_caseD_3;
      }
      goto switchD_004afb05_caseD_1;
    }
  }
  else {
    switch(arg3) {
    case 0:
      goto jpt_memmove_004AFB24;
    case 1:
      goto switchD_004afb05_caseD_1;
    case 2:
      goto switchD_004afb05_caseD_2;
  ...
  switch(arg3) {
  case 1:
switchD_004afb05_caseD_1:
    *(undefined1 *)dataCursor = *(undefined1 *)arg2;
    return arg1;
  case 2:
switchD_004afb05_caseD_2:
    *(undefined1 *)dataCursor = *(undefined1 *)arg2;
    *(undefined1 *)((int)dataCursor + 1) = *(undefined1 *)((int)arg2 + 1);
    return arg1;
  case 3:
switchD_004afb05_caseD_3:
    *(undefined1 *)dataCursor = *(undefined1 *)arg2;
    *(undefined1 *)((int)dataCursor + 1) = *(undefined1 *)((int)arg2 + 1);
    *(undefined1 *)((int)dataCursor + 2) = *(undefined1 *)((int)arg2 + 2);
    return arg1;
  }
jpt_memmove_004AFB24:
  return arg1;
}
