...

{
  ...
  value3 = value & 0x7000;
  if ((value & 0x7000) == 0) {
    entry2 = ResolveSceneContextPackedRelativeBlock
                      (*(int *)(entry + 8) + 0x10 + value2 * 4 + entry,entry2);
    return entry2;
  }
  if (value3 == 0x2000) {
    ...
    entry2 = ResolveSceneAssetRelativePointerEntry
                      (*(int *)(*(int *)(entry2 + 0xc) + 0x10) + value2 * 8 + 0x14 +
                       *(int *)(entry2 + 0xc));
    if (entry2 == 0) {
      return 0;
    }
