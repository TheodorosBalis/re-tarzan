...
// Address: 0x00447E70
// Label: UpdateHudTokenCounterAndExtraLifeAward
...
joined_r0x00447f22:
  ...
  *(ushort *)(g_HudTokenCounterScene + 0xc) = g_HudTokenCounterSpinFrame + 0x2000;
  ...
  value = gCurrentTokensCollected / 10;
  if (value == 0) {
    g_HudTokenTensDigitFlags = g_HudTokenTensDigitFlags & 0x7fff;
  }
  else {
    _g_HudTokenTensDigitSprite = (short)(value % 10) + 0x200f;
  ...
  if (value / 10 == 0) {
    ...
    _g_HudTokenHundredsDigitSprite = (short)((value / 10) % 10) + 0x200f;
