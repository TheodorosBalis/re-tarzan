...
// Address: 0x0049B9F0
// Label: ProjectBoundsVisibilityScratchVertices3Clamped
// Label origin: project
// Original labels and source files are tracked in manifest.csv.

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void ProjectBoundsVisibilityScratchVertices3Clamped(void)

{
  ...
  if (g_ProjectCameraZ0 < _g_RenderNearClipDepth) {
    g_ProjectCameraZ0 = 1.0;
  }
  ...
  g_ProjectCameraZ1 =
       ...
       _g_ProjectTranslateZ;
  if (g_ProjectCameraZ1 < _g_RenderNearClipDepth) {
    g_ProjectCameraZ1 = 1.0;
  }
  ...
  ProjectBoundsVisibilityScratchVertexClamped(2);
  return;
}
