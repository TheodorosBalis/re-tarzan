...

{
  ...
  else if ((g_PauseMenuStatus == 3) && (iVar1 = DrawOptionsMenu(0,0xffffffff), iVar1 == 0)) {
  ...
  if ((g_PauseMenuStatus == 0) && (g_PendingOptionsMenuId == 0)) {
    bIsPaused = 0;
    return;
  }
  bIsPaused = 1;
